...
<transition>
  ...
  >
    ...
    <AppFilterSheet ref="bottomSheet"></AppFilterSheet>
...
import AppFilterSheet from "@/components/App/AppFilterSheet";
...
import AppTab3 from "@/components/App/AppTab3";
...
export default {
  ...
  async asyncData({ store  }) {
    ...
    if(localStorage.getItem("previousPage")=="product-id"){
      ...
      if(localStorage.getItem("selectCat2")) {
      const secondCat = JSON.parse(localStorage.getItem("selectCat2"));
      const secondCatName = secondCat.code
      console.log(secondCat)
      console.log(secondCatName)
      

     if(secondCatName =="000" ) {
      console.log("왔다!")
      localStorage.removeItem("selectCat2");
      }
      else {
    ...
    if(localStorage.getItem("secCat")=="coat") {
        ...
        await store.dispatch("setSecondCategory", { code: "001", name: "코트" });
        localStorage.removeItem("secCat");
    }
    else if(localStorage.getItem("secCat")=="pants") {

        store.dispatch("setFirstCategory", "003"); 
        await store.dispatch("setSecondCategory", { code: "000", name: "전체" });
        localStorage.removeItem("secCat");
    }

    else if(localStorage.getItem("secCat")=="onePiece") {
      
        store.dispatch("setFirstCategory", "005");
        await store.dispatch("setSecondCategory", { code: "000", name: "전체" });
        localStorage.removeItem("secCat");
    }
