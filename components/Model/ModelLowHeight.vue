...
<main>
    <div class="modelHeight" ref="modelHeight" id="modelHeightForCount">
          <div
            id="modelCard"
            v-for="model in MODELS_LOW_HEIGHT"
            :key="model.modelId"
...
export default {
    ...
    data() {
      return {
            isSpinning: false,
            models_low_height: this.$store.getters.MODELS_LOW_HEIGHT,
            moreModel : true,
...
//     }
//     return {
//       models_low_height : store.getters.MODELS_LOW_HEIGHT
//     };
//   },
...
created() {
    if (!localStorage.getItem("previousPage").includes("model")) {
      ...
      window.addEventListener("scroll", this.handleScrollLow);
      window.removeEventListener("scroll", this.handleScroll);
      window.removeEventListener("scroll", this.handleScrollMean);
      window.removeEventListener("scroll", this.handleScrollHign);
},

 methods: {
    async handleScrollLow() {
      
      if (
        this.$route.name=="modelLow" &&
        this.$store.getters.MODELS_LOW_HEIGHT.length !=0 &&
