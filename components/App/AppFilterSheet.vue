  ...
  >
    ...
    <div class="filter">
      <div class="filter__box">
        <span class="filter__name" id="heightFilterName" ref="heigtFilterName">키</span>
      </div>

      <div class="button-container" id="heightFilterButton" ref="heightFilterButton">
        <button
          v-for="heightRange in heightRanges"
          :key="heightRange.heightRange"
          class="button button--full"
          :class="{
            'button--active': TEMPORARY_HEIGHT_RANGE === heightRange.heightRange
          }"
          @click="setTemporaryHeightRange(heightRange.heightRange)"
        >
          {{ heightRange.text }}
        </button>
      </div>
