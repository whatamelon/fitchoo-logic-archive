<template>
  <figure
    ...
    @click="toDetailPage()"
  >
  <div class="home2-product__image-background"
    ...
    <div class="home2-product__info">
        <div class="home2-product__price"
       :class="{ custom: isCustom }"
      ref= "priceCustom">
        {{ separateThousand(product.price) }}
      </div>
      <div class="home2-product__name">{{ product.name }}</div>
    </div>

    <div class="home2-product__model">
      <div class="home2-product__model-name">{{ product.modelName }}</div>
      <div class="home2-product__model-height">
