<template>
  <figure
    ...
    @click="toDetailPage()"
  >
  <div class="home-product__image-background"
    ...
    <div class="home-product__info">
      ...
      <div class="home-product__name">{{ product.name }}</div>
    </div>

    <div class="home-product__model">
      <div class="home-product__model-name">{{ product.modelName }}</div>
      <div class="home-product__model-height">
